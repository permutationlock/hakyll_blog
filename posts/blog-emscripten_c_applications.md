...
different output targets:
 ...
 - HTML: minifies the `.js` bindings and uses a template to generate a
   `.html` file to load and run the application. The default HTML template
...
simply read through the non-minified bindings generated by the
JavaScript target.
In this post I will outline how to create your own HTML file and
